...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedEmail = data.email.trim().toLowerCase(); // ✅ Trim and lowercase email
    ...
    try {
        const dataResponse = await fetch(SummaryApi.signUP.url, {
            ...
            body: JSON.stringify({
                ...
                role: "GENERAL", // ✅ Ensure role is sent
            }),            
        });

        const dataApi = await dataResponse.json();
        console.log("🔹 Backend Response:", dataApi); // ✅ Log backend response
        if (dataApi.success) {
